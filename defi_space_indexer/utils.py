...
async def get_token_info(address: str) -> tuple:
    ...
    try:
        ...
        try:
            ...
            logger.warning(f"Error getting name for {address}: {str(e)}")
            name = "Unknown"
        ...
        try:
            ...
            logger.warning(f"Error getting symbol for {address}: {str(e)}")
            symbol = "UNK"
        ...
        try:
            ...
            logger.warning(f"Error getting decimals for {address}: {str(e)}")
