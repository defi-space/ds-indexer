...
class WhitelistedUser(Model):
    ...
    # Relationships
    faucet: fields.ForeignKeyField[Faucet] = fields.ForeignKeyField('models.Faucet', related_name='users')
...
class ClaimEvent(Model):
    ...
    # Relationships
    faucet: fields.ForeignKeyField[Faucet] = fields.ForeignKeyField('models.Faucet', related_name='claims')
