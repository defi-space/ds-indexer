...
class Farm(Model):
    ...
    # Relationships
    factory: fields.ForeignKeyField[FarmFactory] = fields.ForeignKeyField('models.FarmFactory', related_name='farms')
...
class AgentStake(Model):
    ...
    # Relationships
    farm: fields.ForeignKeyField[Farm] = fields.ForeignKeyField('models.Farm', related_name='agent_stakes')
...
class Reward(Model):
    ...
    # Relationships
    farm: fields.ForeignKeyField[Farm] = fields.ForeignKeyField('models.Farm', related_name='rewards')
...
class RewardPerAgent(Model):
    ...
    reward: fields.ForeignKeyField[Reward] = fields.ForeignKeyField('models.Reward', related_name='agent_rewards')
...
class Rewarder(Model):
    ...
    # Relationships
    farm: fields.ForeignKeyField[Farm] = fields.ForeignKeyField('models.Farm', related_name='rewarders')
...
class AgentStakeEvent(Model):
    ...
    # Relationships
    farm: fields.ForeignKeyField[Farm] = fields.ForeignKeyField('models.Farm', related_name='stake_events')
    stake: fields.ForeignKeyField[AgentStake] = fields.ForeignKeyField('models.AgentStake', related_name='events')
...
class RewardEvent(Model):
    ...
    # Relationships
    farm: fields.ForeignKeyField[Farm] = fields.ForeignKeyField('models.Farm', related_name='reward_events')
