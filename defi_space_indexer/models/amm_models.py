...
class Pair(Model):
    ...
    # Relationships
    factory: fields.ForeignKeyField[AmmFactory] = fields.ForeignKeyField('models.AmmFactory', related_name='pairs')
...
class LiquidityPosition(Model):
    ...
    withdrawals_token0 = fields.DecimalField(
        max_digits=100, decimal_places=0, null=True
    )  # Cumulative token0 withdrawals
    withdrawals_token1 = fields.DecimalField(
        max_digits=100, decimal_places=0, null=True
    )  # Cumulative token1 withdrawals
    ...
    # Relationships
    pair: fields.ForeignKeyField[Pair] = fields.ForeignKeyField('models.Pair', related_name='liquidity_positions')
...
class LiquidityEvent(Model):
    ...
    # Relationships
    pair: fields.ForeignKeyField[Pair] = fields.ForeignKeyField('models.Pair', related_name='liquidity_events')
...
class SwapEvent(Model):
    ...
    # Relationships
    pair: fields.ForeignKeyField[Pair] = fields.ForeignKeyField('models.Pair', related_name='swaps')
