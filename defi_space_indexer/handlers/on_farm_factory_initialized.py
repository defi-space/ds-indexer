...
from defi_space_indexer.types.farming_factory.starknet_events.farm_factory_initialized import (
    FarmFactoryInitializedPayload,
)
...
async def on_farm_factory_initialized(
    ...
    ctx.logger.info(
        f'Farm factory initialized: address={farm_factory_address}, owner={owner}, farm_class_hash={farm_class_hash}'
    )
