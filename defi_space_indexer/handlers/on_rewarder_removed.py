...
async def on_rewarder_removed(
    ...
    rewarder = await models.Rewarder.get_or_none(address=rewarder_address, farm_address=farm_address)
    ...
    ctx.logger.info(f'Rewarder removed: farm={farm_address}, rewarder={rewarder_address}')
